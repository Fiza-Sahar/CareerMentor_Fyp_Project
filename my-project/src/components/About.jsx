...
import aboutusImg from '../assets/Images/aboutusImg.jpg'; // Assuming Images folder is one level up
...
function About() {
  return (
    ...
    <div  className='md:px-14 max-w-s mx-auto aboutus' id='about'>
      <h1 className="md:text-7x1 text-4x1 font-bold  mb-6 leading-relaxed h1-large text-center">About Us</h1>
